...
//
//(function (e, t, n, r) {
//    var i = "ontouchstart" in t, s = i ? "touchstart" : "mousedown", o = i ? "touchmove" : "mousemove", u = i ? "touchend" : "mouseup", a = i ? "touchcancel" : "mouseup", f = function (e) {
//        var t = Math.floor(e / 3600), n = Math.floor(e % 3600 / 60), r = Math.ceil(e % 3600 % 60);
...
//            var r = e(this), u = r.attr("src"), c = r.get(0).getAttribute("autoplay"), c = c === "" || c === "autoplay" ? true : false, h = r.get(0).getAttribute("loop"), h = h === "" || h === "loop" ? true : false, p = false;
...
//                })
//            } else if (l(u))p = true;
//            var d = e('<div class="' + t.classPrefix + '">' + (p ? e("<div>").append(r.eq(0).clone()).html() : '<embed src="' + u + '" width="0" height="0" volume="100" autostart="' + c.toString() + '" loop="' + h.toString() + '" />') + '<div class="' + n.playPause + '" title="' + t.strPlay + '"><a href="#">' + t.strPlay + "</a></div></div>"), v = p ? d.find("audio") : d.find("embed"), v = v.get(0);
//            if (p) {
//                d.find("audio").css({width: 0, height: 0, visibility: "hidden"});
...
//                var m = d.find("." + n.bar), g = d.find("." + n.barPlayed), y = d.find("." + n.barLoaded), b = d.find("." + n.timeCurrent), w = d.find("." + n.timeDuration), E = d.find("." + n.volumeButton), S = d.find("." + n.volumeAdjust + " > div"), x = 0, T = function (e) {
...
//                }, 100);
//                var k = v.volume, L = v.volume = .111;
//                if (Math.round(v.volume * 1e3) / 1e3 == L)v.volume = k; else d.addClass(n.noVolume);
//                w.html("…");
//                b.text(f(0));
